...
namespace WinformsImeControlWithUserControlBasics.L010DrawWithCompositionAttr {
    public partial class Native {
        ...
        // CompositionStringAttributes. imm_ prefix append by me to avoid Conflict with FileAttr.

        /// <summary> Selected: F, Translated: F </summary>
        public const byte imm_ATTR_INPUT = 0;
        /// <summary> Selected: T, Translated: T </summary>
        public const byte imm_ATTR_TARGET_CONVERTED = 1;
        /// <summary> Selected: F, Translated: T </summary>
        public const byte imm_ATTR_CONVERTED = 2;
        /// <summary> Selected: T, Translated: F </summary>
        public const byte imm_ATTR_TARGET_NOTCONVERTED = 3;
        /// <summary> Invalid Char </summary>
        public const byte imm_ATTR_INPUT_ERROR = 4;
        /// <summary> Characters that the IME will no longer convert. </summary>
        public const byte imm_ATTR_FIXEDCONVERTED = 5;
